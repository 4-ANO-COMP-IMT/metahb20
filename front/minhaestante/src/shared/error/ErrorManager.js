function translateErrorMessage(error) {
	const errorMessages = {
		...
		"Field edition isn't in the right type.\n Received: object.\n Expected: number":
			"Campo Edição inválida. Recebido: objeto. Esperado: número",
		"Field pages isn't in the right type.\n Received: object.\n Expected: number":
			"Campo Páginas inválida. Recebido: objeto. Esperado: número",
		"Field publishDate isn't in the right type.\n Received: object.\n Expected: number":
			"Campo Data de Publicação inválida. Recebido: objeto. Esperado: data",
